...
//		testApplicationContext01();
	...
	private static void testApplicationContext02() {
		ApplicationContext ac = new ClassPathXmlApplicationContext("config/applicationContext02.xml");
		
		User1 user1 = ac.getBean(User1.class);
		System.out.println(user1.getName());	//	여기까진 됨
...
//		user = ac.getBean(User.class);
	...
	private static void testApplicationContext01() {		
		ApplicationContext ac = new ClassPathXmlApplicationContext("config/applicationContext01.xml");
	...
	private static void testBeanFactory01() {		
		BeanFactory bf = new XmlBeanFactory(new ClassPathResource("config/applicationContext01.xml"));
	...
	private static void testBeanFactory02() {
		BeanFactory bf = new XmlBeanFactory(new ClassPathResource("config/applicationContext02.xml"));
		...
		// 명시적으로 설정해야한다.
		user1 = (User1)bf.getBean("user1");
		System.out.println(user1.getName());	//	널포인터
	}
}
